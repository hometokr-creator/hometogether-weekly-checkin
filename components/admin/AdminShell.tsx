    ...
    <main className="min-h-screen bg-[#f4f7f5] text-[#17211d]">
      <header className="border-b border-[#dce5e1] bg-white/95">
        <div className="mx-auto flex w-full max-w-[1440px] flex-wrap items-center justify-between gap-4 px-5 py-4 sm:px-8">
          <Link className="flex min-h-11 items-center gap-3 no-underline" href="/admin/checkins">
            <span className="grid h-9 w-9 place-items-center rounded-xl rounded-bl-sm bg-[#176b52] text-xs font-black text-white">
              홈
            </span>
            <span>
              <b className="block text-base tracking-[-0.02em]">홈투게더 운영팀</b>
              <small className="block text-xs text-[#718078]">공동생활 주간 체크인</small>
            </span>
          </Link>

          <nav className="flex flex-wrap items-center gap-1" aria-label="관리자 메뉴">
            <Link className={navClass(active === "checkins")} href="/admin/checkins">
      ...
      <div className="mx-auto w-full max-w-[1440px] px-5 py-8 sm:px-8 sm:py-10">
        <div className="mb-8 flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
          <div>
            ...
            <h1 className="m-0 text-3xl font-black tracking-[-0.04em] sm:text-4xl">{title}</h1>
